#!/usr/bin/env python3
"""One-off: import the first folk batch — 6 files, 3 duplicate-title pairs
renamed distinct same as every prior batch. Fills sundayfolk, empty until
now.

    python3 scripts/import_folk_batch.py
"""
...
TRACKS = [
    ("Blue Jean Porch_folk.mp3", "sundayfolk", "Blue Jean Porch"),
    ("Blue Jean Porch_1_folk.mp3", "sundayfolk", "Porch Light Waltz"),
    ("Heather on the Hill_folk.mp3", "sundayfolk", "Heather on the Hill"),
    ("Heather on the Hill_1_folk.mp3", "sundayfolk", "Wildflower Hill"),
    ("How the Whole Thing Grows_folk.mp3", "sundayfolk", "How the Whole Thing Grows"),
    ("How the Whole Thing Grows _folk.mp3", "sundayfolk", "Roots and Rafters"),
]
